...
const animalImage =[{name:"start"},{name:"tiger",eat:"meat",src:"./tiger.jpeg",sound:"roaring"},{name:"cat",eat:"milk",src:"./cat.jpeg",sound:"Meow"},
    {name:"dog",eat:"chapati",src:"./dog.jpeg",sound:"bark"},{name:"cow",eat:"grace",src:"./cow.jpeg",sound:"maa.."},{name:"end"}]
...
function ImageSlider() {
  ...
  return (
    <div className="card">
        ...
        <p>{animalImage[count===animalImage.length-1 ? count:count+1].name}</p>
        </div>
